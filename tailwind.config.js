export default {
  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        'headline-md': ['Orbitron', 'Plus Jakarta Sans', 'sans-serif'],
        'body-lg': ['Inter', 'Outfit', 'sans-serif'],
        'headline-lg': ['Orbitron', 'Plus Jakarta Sans', 'sans-serif'],
        'display-lg': ['Orbitron', 'Plus Jakarta Sans', 'sans-serif'],
        'label-sm': ['Geist', 'sans-serif'],
        'headline-lg-mobile': ['Orbitron', 'Plus Jakarta Sans', 'sans-serif'],
